...
def plot_rg(filename1,figout):
    ...
    ax.plot(position_z,densitys[:,8],color=cm.colors[16],label='32-36 us',alpha=0.8)
    ...
    ax.set_title('TIA1LCD Density profle along Z Axis',fontproperties=font_prop)
    plt.ylim(0,1000)
...
plot_rg('density-collect-36000ns-interval4000ns.xvg','density.png')

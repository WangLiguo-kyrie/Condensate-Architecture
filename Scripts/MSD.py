...
for i in range(copy):
    ...
    #gromacs 2023.4:
    #os.system('echo "{}\n" |gmx msd -f {}/last1us_whole-nojump-trans.xtc -s {}/production2-Verlet.tpr -n ../MSD_folded.ndx -o MSD_folded{}.xvg -beginfit 0 -endfit 20000  -b 29500000'.format(str(i+1),trajectory_dir,trajectory_dir,str(i+1)))
